...
<x-app-layout>
            ...
            <section>
                ...
                <form method="post" action="{{ route('total.quiz') }}" class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="total_quiz" name="total_quiz" type="text" class="mt-1 block w-full" :value="old('total_quiz', $independentAd->total_quiz)" required autofocus autocomplete="name" />
                        <x-input-error class="mt-2" :messages="$errors->get('total_quiz')" />
                    </div>
                    <div>
                        <x-input-label for="quiz_time" :value="__('Quiz Time')" />
                        <x-text-input id="quiz_time" name="quiz_time" type="text" class="mt-1 block w-full" :value="old('quiz_time', $independentAd->quiz_time)" required autofocus autocomplete="name" />
    ...
    <div class="bg-[#FFFFFF] rounded-[12px] pt-3 pb-10 mb-10 px-4">
        <h3 class="text-[#0D2927] f-plus font-[500] text-[24px]">Quiz</h3>
            ...
            <table
                ...
                {{-- <tbody class="">
                    ...
                    @endphp
                        ...
                        <tr class="bg-[#EEF6F1] rounded-[4px] mb-3 py-4">
                            <td class="px-4 py-2 f-inter font-[500] text-[16px]"> <ul class="list-disc list-inside">
                            ...
                            <td class="px-4 py-2 text-center text-[14px] f-inter font-[400] text-[#3C4151]">{{$ads->tabName}}</td>
                            <td class="px-4 py-2">
                                <div class="flex justify-end pr-5">
                                    <a href="{{route('deleteAds',$ads->id)}}" onclick="return confirm('Are you sure ?')">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2 4H3.33333H14" stroke="#AC2221" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12.6673 4.00016V13.3335C12.6673 13.6871 12.5268 14.0263 12.2768 14.2763C12.0267 14.5264 11.6876 14.6668 11.334 14.6668H4.66732C4.3137 14.6668 3.97456 14.5264 3.72451 14.2763C3.47446 14.0263 3.33398 13.6871 3.33398 13.3335V4.00016M5.33398 4.00016V2.66683C5.33398 2.31321 5.47446 1.97407 5.72451 1.72402C5.97456 1.47397 6.3137 1.3335 6.66732 1.3335H9.33398C9.68761 1.3335 10.0267 1.47397 10.2768 1.72402C10.5268 1.97407 10.6673 2.31321 10.6673 2.66683V4.00016" stroke="#AC2221" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M6.66602 7.3335V11.3335" stroke="#AC2221" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M9.33398 7.3335V11.3335" stroke="#AC2221" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg> </a>

                                    <a href="{{route('editAds',$ads->id)}}" >
                                        <svg class="h-5 w-6 ml-3 text-green-700"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M4 20h4l10.5 -10.5a1.5 1.5 0 0 0 -4 -4l-10.5 10.5v4" />  <line x1="13.5" y1="6.5" x2="17.5" y2="10.5" /></svg></a>
                                 </div>
                            </td>
                        </tr>
                        @endforeach
